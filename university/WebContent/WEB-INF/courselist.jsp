...
<body>
	<f:view>
		...
		<h:panelGrid columns="1">
			<rich:scrollableDataTable id = "courseTable" binding="#{courseBean.courseTable}" value="#{courseBean.courseList}"
				...
				<rich:column id="length" width="60px">
					<f:facet name="header"><h:outputText value="duree"/></f:facet>
